...
## 2026-05-21 - 统一第一方 markdown 编码

- 类型：docs / 维护
- 关联需求文档：`docs/requirements/2026-05-21-markdown-encoding-normalization.md`
- 影响范围：根目录说明、部署说明、项目文档、需求文档、规范文档
- 验证说明：确认第一方 markdown 统一采用 UTF-8 编码，内容未改写
- 回滚说明：移除 BOM 并恢复变更前的文件字节内容
