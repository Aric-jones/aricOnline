<template>
    <div class="login">
        ...
        <div class="el-login-footer">
            <span>Copyright © 2026 - {{ new Date().getFullYear() }} By 牧羊人</span>
        </div>
    </div>
</template>
...
.login {
    ...
    align-items: center;
    height: 100%;
    background-image: url("https://big-event0611.oss-cn-beijing.aliyuncs.com/article/368b3faf40154c91c404b15c0caf198f.png");
